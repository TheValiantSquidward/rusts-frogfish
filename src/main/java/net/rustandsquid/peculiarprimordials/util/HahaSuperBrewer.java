package net.rustandsquid.peculiarprimordials.util;
...
public class HahaSuperBrewer implements IBrewingRecipe {
    private final Potion input;
    private final Item ingredient;
    private final Potion output;

    public HahaSuperBrewer(Potion input, Item ingredient, Potion output) {
        this.input = input;
