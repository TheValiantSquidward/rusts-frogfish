...
public class BlochiusProjectileEntityRenderer extends GeoEntityRenderer<BlochiusEntity> {

    public BlochiusProjectileEntityRenderer(EntityRendererProvider.Context renderManager) {
