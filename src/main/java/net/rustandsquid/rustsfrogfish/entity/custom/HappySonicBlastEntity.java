...
public class HappySonicBlastEntity extends Entity implements IAnimatable {

    private static final EntityDataAccessor<Boolean> FASTER_ANIM = SynchedEntityData.defineId(HappySonicBlastEntity.class, EntityDataSerializers.BOOLEAN);
    private UUID ownerUUID;
    private int ownerNetworkId;
    private boolean leftOwner;

    public HappySonicBlastEntity(EntityType p_i50162_1_, Level p_i50162_2_) {
        super(p_i50162_1_, p_i50162_2_);
    }

    public HappySonicBlastEntity(Level worldIn, LivingEntity p_i47273_2_, boolean right) {
        this(ModEntityTypes.HAPPY_SONIC_BLAST.get(), worldIn);
    ...
    public HappySonicBlastEntity(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this(ModEntityTypes.HAPPY_SONIC_BLAST.get(), world);
    }
