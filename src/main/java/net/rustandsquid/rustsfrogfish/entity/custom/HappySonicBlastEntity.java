...
public class HappySonicBlastEntity extends BetterAbstractHurtingProjectile implements IAnimatable {
    ...
    public HappySonicBlastEntity(EntityType<? extends HappySonicBlastEntity> p_i50160_1_, Level p_i50160_2_) {
        super(p_i50160_1_, p_i50160_2_);
    }

    public HappySonicBlastEntity(net.minecraft.world.level.Level worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ,
                                 float directHitDamage) {
        super(ModEntityTypes.HAPPYSONICBLAST.get(), shooter, accelX, accelY, accelZ, worldIn);
        this.directHitDamage = directHitDamage;
    }

    public HappySonicBlastEntity(net.minecraft.world.level.Level worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
        super(ModEntityTypes.HAPPYSONICBLAST.get(), x, y, z, accelX, accelY, accelZ, worldIn);
    }
