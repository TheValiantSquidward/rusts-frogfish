...
public class BlochiusEntity extends WaterAnimal implements Bucketable, IAnimatable {
    ...
    private static final EntityDataAccessor<Boolean> FROM_BOOK = SynchedEntityData.defineId(BlochiusEntity.class, EntityDataSerializers.BOOLEAN);


    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public BlochiusEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    public static boolean checkSurfaceWaterDinoSpawnRules(EntityType<? extends BlochiusEntity> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
