...
public enum material implements ArmorMaterial {
    ...
    NEILPEARTIA("neilpeartia", 28, new int[]{2, 4, 8, 3}, 19, SoundEvents.ARMOR_EQUIP_LEATHER,
            2.0F, 0.0F, () -> Ingredient.of(ModItems.FISH_LEATHER.get()));
    ...
    material(String p_40474_, int p_40475_, int[] p_40476_, int p_40477_,
